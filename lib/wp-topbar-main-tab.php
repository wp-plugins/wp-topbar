		...
		<div class="table">
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						<input class="ui-front" type="text" id="wptbstarttimebtn" name="wptbstarttime"  style="position: relative; z-index: 100000;" size="30" value="<?php echo $wptbOptions['start_time']; ?>"></div><p class="button" style="<?php _e( $wptb_special_button_style , 'wptb' ); ?>" id="wptbstarttimebtnClear">Set Start Time to Zero</p>									  
				...
				<tr valign="top">
					...
					<td>
						<input class="ui-front" type="text" id="wptbendtimebtn" name="wptbendtime"  style="position: relative; z-index: 100000;" size="30" value="<?php echo $wptbOptions['end_time']; ?>">	<p class="button" style="<?php _e( $wptb_special_button_style , 'wptb' ); ?>" id="wptbtimebtnClear">&nbspSet End Time to Zero</p>							  
