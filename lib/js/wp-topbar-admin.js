...
//
//
   jQuery( "#wtpb-rotatedisplaytime" ).slider({
    ...
    jQuery( "#rotatedisplaytime" ).val( jQuery( "#wtpb-rotatedisplaytime" ).slider( "value" ) );
   
	jQuery( "#rotatedisplaytime" ).change(function() {
	    jQuery( "#wtpb-rotatedisplaytime" ).slider( "value", jQuery(this).val() );
	}); 
//
//
//
   jQuery( "#wtpb-rotatestartdelay" ).slider({
    ...
    jQuery( "#rotatestartdelay" ).val( jQuery( "#wtpb-rotatestartdelay" ).slider( "value" ) );
   
	jQuery( "#rotatestartdelay" ).change(function() {
	    jQuery( "#wtpb-rotatestartdelay" ).slider( "value", jQuery(this).val() );
	});  
	//
//
//
   jQuery( "#wtpb-rotatecount" ).slider({
    ...
    jQuery( "#rotatecount" ).val( jQuery( "#wtpb-rotatecount" ).slider( "value" ) );
   
	jQuery( "#rotatecount" ).change(function() {
	    jQuery( "#wtpb-rotatecount" ).slider( "value", jQuery(this).val() );
	});    
//
//
//
...
//
   jQuery( "#wtpb-marginleft" ).slider({
    ...
    jQuery( "#marginleft" ).val( jQuery( "#wtpb-marginleft" ).slider( "value" ) );
   
	jQuery( "#marginleft" ).change(function() {
	    jQuery( "#wtpb-marginleft" ).slider( "value", jQuery(this).val() );
	});   
//
//
//
   jQuery( "#wtpb-marginright" ).slider({
    ...
    jQuery( "#marginright" ).val( jQuery( "#wtpb-marginright" ).slider( "value" ) );
   
	jQuery( "#marginright" ).change(function() {
	    jQuery( "#wtpb-marginright" ).slider( "value", jQuery(this).val() );
	});   
//
//
//
