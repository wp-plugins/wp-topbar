jQuery(document).ready(function() {
	...
	jQuery('#wptbstarttimebtn').AnyTime_noPicker().AnyTime_picker({format: "%Y-%m-%d %H:%i:%s (%+)",formatUtcOffset: "%: (%@)"});
	jQuery('#wptbendtimebtn').AnyTime_noPicker().AnyTime_picker({format: "%Y-%m-%d %H:%i:%s (%+)",formatUtcOffset: "%: (%@)"});
