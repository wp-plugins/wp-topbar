...
<div id="topbar">
	...
	">
		...
		"href="<?php echo $wptbOptions['bar_link']; ?>"target="_blank"><?php echo stripslashes($wptbOptions['bar_link_text']); ?></a>
	</p>  
</div>
		<?php	
		}
...
<h2><a name="Top"><?php _e( 'WP-Topbar - Version 1.3', 'wptb' ); ?></a></h2>
<div class="postbox">
